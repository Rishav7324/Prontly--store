  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-20 max-w-3xl">
        <h1 className="text-4xl font-bold font-headline mb-4 text-foreground">Refund Policy</h1>
        <p className="text-muted-foreground mb-12 text-sm italic">Last updated: May 20, 2026</p>

        <div className="prose-content space-y-10">
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">1. Nature of Digital Goods</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">2. Exceptions for Refunds</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">4. Processing Timeline</h2>
            <p>
          ...
          <section className="p-8 bg-blue-50/50 rounded-2xl border border-blue-100">
            <h2 className="text-lg font-bold mb-2 text-foreground">Duplicate Purchases</h2>
            <p className="text-sm">
