  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-20 max-w-3xl">
        <h1 className="text-4xl font-bold font-headline mb-4 text-midnight-ink">Digital Delivery Policy</h1>
        <p className="text-muted-foreground mb-12 text-sm italic">Last updated: May 20, 2026</p>

        <div className="prose-content space-y-10">
          <section>
            <h2 className="text-2xl font-bold mb-4 text-midnight-ink">1. Electronic Fulfillment Only</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-midnight-ink">2. Delivery Mechanisms</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-midnight-ink">3. Delivery Timeline</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-midnight-ink">4. Licensing & Usage</h2>
            <p>
          ...
          <section className="p-8 bg-muted/30 rounded-2xl border border-stone-gray/10">
            <h2 className="text-xl font-bold mb-4 text-midnight-ink">5. Support & Troubleshooting</h2>
