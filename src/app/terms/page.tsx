  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-20 max-w-3xl">
        <h1 className="text-4xl font-bold font-headline mb-4 text-foreground">Terms of Service</h1>
        ...
        <div className="prose-content space-y-10">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">2. Digital Product Licensing</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">3. User Conduct & Prohibited Uses</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-foreground">4. Payments & Fulfillment</h2>
            <p>
